...
## Run example (course environment)
Run command:

    python our_solution.py instance.txt 5

We tested seeds 1..5 and selected the best-performing one:
- Best seed found: 5 (lowest cost among seeds 1..5)
- Example result (from our run): Checker: Valid solution — Cost: 2356.0
